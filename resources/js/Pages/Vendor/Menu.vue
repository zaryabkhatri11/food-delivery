                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900 overflow-x-scroll flex flex-col gap-8">
                        <div class="flex gap-4">
                            <Link v-if="can('category.create')" class="btn btn-primary" :href="route('vendor.categories.create')"> 
                        ...
                        <div v-for="category in categories" :key="category.id" class="flex flex-col gap-4">
                            <div class="flex justify-between">
                                ...
                                <div class="flex gap-4 items-center">
                                    <Link class="btn btn-primary" :href="route('vendor.categories.edit', category)">
                                        Edit
                                    </Link>
